<template>
    <div>
      <div>
        <input type="file" ref="upload" style="display: none;" :disabled="status !== Status.wait" @change="handleFileChange" />
        <el-button @click="handleSelect">上传</el-button>
        <!-- <el-button v-else @click="handleUpload" :disabled="uploadDisabled">上传</el-button> -->
